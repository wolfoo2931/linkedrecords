...
async function expectToSeeManagementUrls(client, node) {
  assert(node?.id, 'expectToSeeManagementUrls: node must have an id property');
  ...
  expect(urls).to.haveOwnProperty('cancel');
...
describe('paddle notification events', () => {
  ...
  it('is possible to send a payment event in order to upgrade a quota for an user', async () => {
    ...
    expect(!!quota.isUpgraded).to.eql(false);
  ...
  describe('details for accountee', () => {
    ...
    it('does not allow an member to see the paddle management links', async () => {
    ...
    it('does not allow an host to see the paddle management links', async () => {
      const [accountee, other] = await Session.getTwoSessions();
    ...
    it('does not allow an user with read right to see the paddle management links', async () => {
      const [accountee, other] = await Session.getTwoSessions();
    ...
    it('does not allow an user with refine right to see the paddle management links', async () => {
      const [accountee, other] = await Session.getTwoSessions();
    ...
    it('does not allow an user with referTo right to see the paddle management links', async () => {
      const [accountee, other] = await Session.getTwoSessions();
