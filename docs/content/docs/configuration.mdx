...
| `QUOTA_COUNT_KV_RECORDS` | Max key-value records | - |
| `QUOTA_COUNT_LT_RECORDS` | Max long-text records | - |
| `QUOTA_COUNT_BLOB_ATTRIBUTES` | Max blob records | - |

```bash
DEFAULT_STORAGE_SIZE_QUOTA=500
QUOTA_COUNT_KV_RECORDS=10000
QUOTA_COUNT_LT_RECORDS=1000
```
