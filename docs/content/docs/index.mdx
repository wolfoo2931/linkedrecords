---
title: Introduction
description: LinkedRecords - A Backend-as-a-Service for collaborative web applications
---
...
What if your users could choose where their data lives - on their own infrastructure, in their own jurisdiction? What if AI coding assistants couldn't accidentally create security holes because authorization is baked into every operation? What if multiple apps could work with the same data without any integration work?
